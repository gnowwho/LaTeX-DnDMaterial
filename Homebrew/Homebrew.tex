...
\input{0-CopertinaInizio/Copertina}

\input{1-StrutturaDelCosmo/Cosmo}
...
\input{2-Razze/2.2-FeyCorgi/FeyCorgi}
...
\input{../MasterMaterial/RegnoOster/OsterPubblico}
\input{../MasterMaterial/Chiesa/Chiesa}
\input{4-Territori/Location_merger}

\chapter{Capitolo 5: NPCs}
\input{5-NPCs/NPCMinori}

\chapter{Capitolo 6: Oggetti ed Equipaggiamenti}
\input{6-Oggetti/AdventuringGears}
